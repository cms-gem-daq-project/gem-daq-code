#ifndef gem_hw_vmeDisc_VMEDISCManagerWeb_h
#define gem_hw_vmeDisc_VMEDISCManagerWeb_h
...
namespace gem {
  namespace hw {
    namespace vmeDisc {
      ...
      class VMEDISCManagerVME;

      class VMEDISCManagerWebVME : public gem::base::GEMWebApplication
	{

	  //friend class VMEDISCMonitorVME;
	  //friend class VMEDISCManagerVME;

	public:
	  VMEDISCManagerWebVME(VMEDISCManagerVME *vmeDiscApp);

	  virtual ~VMEDISCManagerWebVME();
	...
	private:
	  //size_t level;
	  //VMEDISCManagerVME *vmeDiscManagerVMEP_;
	  //VMEDISCManagerWebVME(VMEDISCManagerWebVME const&);
