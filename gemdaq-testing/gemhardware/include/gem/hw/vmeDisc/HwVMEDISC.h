#ifndef gem_hw_vmeDisc_HwVMEDISC_h
#define gem_hw_vmeDisc_HwVMEDISC_h
...
#include "gem/hw/vmeDisc/exception/Exception.h"
...
namespace gem {
  namespace hw {
    namespace vmeDisc {
      ...
      class HwVMEDISC: public gem::hw::GEMHwDeviceVME
	{
