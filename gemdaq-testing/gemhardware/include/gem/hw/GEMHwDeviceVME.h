#ifndef gem_hw_GEMHwDeviceVME_h
#define gem_hw_GEMHwDeviceVME_h
...
#include "hal/hal.hpp"		//<--- VME?
//#include "uhal/Utilities.hpp"
#include "uhal/Utilities.hpp"	//<--- VME?
...
namespace gem {
  namespace hw {
	...
	/** 
	 * GEMHwDeviceVME constructor 
	 * @param gemLogger pointer to log4cplus::Logger
	 **/
	GEMHwDeviceVME(const log4cplus::Logger& gemLogger
	...
	/*
	GEMHwDeviceVME(xdaq::Application* xdaqApp,
