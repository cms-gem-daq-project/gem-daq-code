...
#include "gem/hw/GEMHwDeviceVME.h"

gem::hw::GEMHwDeviceVME::GEMHwDeviceVME(const log4cplus::Logger& gemLogger):
  ...
  
{
  ...
  //gem::hw::GEMHwDeviceVME::initDevice();
  /** 
...
gem::hw::GEMHwDeviceVME::~GEMHwDeviceVME()
{
  if (gemHWP_)
    releaseDevice();
}

std::string gem::hw::GEMHwDeviceVME::printErrorCounts() const {
...
void gem::hw::GEMHwDeviceVME::connectDevice()
{
...
void gem::hw::GEMHwDeviceVME::configureDevice()
{
  
}

void gem::hw::GEMHwDeviceVME::releaseDevice()
{
  if (gemHWP_ != 0) {
    delete gemHWP_;
    gemHWP_ = 0;
...
void gem::hw::GEMHwDeviceVME::enableDevice()
{
  if (!isHwConnected()) {
...
//void gem::hw::GEMHwDeviceVME::disableDevice()
//{
//
//}
//
//void gem::hw::GEMHwDeviceVME::pauseDevice()
//{
//
//}
//
//void gem::hw::GEMHwDeviceVME::startDevice()
//{
//
//}
//
//void gem::hw::GEMHwDeviceVME::stopDevice()
//{
//
//}
//
//void gem::hw::GEMHwDeviceVME::resumeDevice()
//{
//
//}
//
//void gem::hw::GEMHwDeviceVME::haltDevice()
//{
//
//}
//
//void gem::hw::GEMHwDeviceVME::initDevice() 
//{
//
//}

uhal::HwInterface& gem::hw::GEMHwDeviceVME::getGEMHwInterface() const
{
  if (gemHWP_ == 0) {
...
uint32_t gem::hw::GEMHwDeviceVME::readReg(std::string const& name)
{
  ...
  int retryCount = 0;
  uint32_t res;
  DEBUG("gem::hw::GEMHwDeviceVME::readReg " << name << std::endl);
...
void gem::hw::GEMHwDeviceVME::readRegs(std::vector<std::pair<std::string, uint32_t> > &regList)
{
  gem::utils::LockGuard<gem::utils::Lock> guardedLock(hwLock_);
  uhal::HwInterface& hw = getGEMHwInterface();
...
void gem::hw::GEMHwDeviceVME::writeReg(std::string const& name, uint32_t const val)
{
  gem::utils::LockGuard<gem::utils::Lock> guardedLock(hwLock_);
  uhal::HwInterface& hw = getGEMHwInterface();
  int retryCount = 0;
...
void gem::hw::GEMHwDeviceVME::writeRegs(std::vector<std::pair<std::string, uint32_t> > const& regList)
{
  gem::utils::LockGuard<gem::utils::Lock> guardedLock(hwLock_);
  uhal::HwInterface& hw = getGEMHwInterface();
  int retryCount = 0;
...
void gem::hw::GEMHwDeviceVME::writeValueToRegs(std::vector<std::string> const& regNames, uint32_t const& regValue)
{
...
/*
void gem::hw::GEMHwDeviceVME::zeroReg(std::string const& name)
{
  writeReg(name,0);
}
*/

void gem::hw::GEMHwDeviceVME::zeroRegs(std::vector<std::string> const& regNames)
{
...
std::vector<uint32_t> gem::hw::GEMHwDeviceVME::readBlock(std::string const& name)
{
  gem::utils::LockGuard<gem::utils::Lock> guardedLock(hwLock_);
  uhal::HwInterface& hw = getGEMHwInterface();
...
std::vector<uint32_t> gem::hw::GEMHwDeviceVME::readBlock(std::string const& name, size_t const& numWords)
{
  gem::utils::LockGuard<gem::utils::Lock> guardedLock(hwLock_);
  uhal::HwInterface& hw = getGEMHwInterface();
...
void gem::hw::GEMHwDeviceVME::writeBlock(std::string const& name, std::vector<uint32_t> const values)
{
  gem::utils::LockGuard<gem::utils::Lock> guardedLock(hwLock_);
  if (values.size() < 1) 
    return;
...
bool gem::hw::GEMHwDeviceVME::knownErrorCode(std::string const& errCode) const {
...
void gem::hw::GEMHwDeviceVME::updateErrorCounters(std::string const& errCode) {
...
void gem::hw::GEMHwDeviceVME::zeroBlock(std::string const& name)
{
  gem::utils::LockGuard<gem::utils::Lock> guardedLock(hwLock_);
  uhal::HwInterface& hw = getGEMHwInterface();
  size_t numWords = hw.getNode(name).getSize();
